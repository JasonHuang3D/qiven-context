# ContextKernel K5 (program contract — RE-TARGETED by ADR-0040)

> K5 is no longer a Python-ContextKernel stage. ADR-0040 (2026-09-21)
> re-targeted the K5 goal to the Runtime canonical-cognition delivery
> path (obligation OBL-20260920T235500Z-B6C1D8, Runtime
> CanonicalCognitionPort). The lossless-transport semantic requirements
> below carry over to that path; references to the sealed K4 reference
