...
The candidate must recover the current collaboration role split, execution-mode control, exact-head validation rules and conditional merge authority from the exact Context snapshot.
