# ContextKernel K1 (historical program contract — sealed, ADR-0040)

> The ContextKernel Python program is sealed permanently (ADR-0040,
> 2026-09-21): suites never registered, gates never run, code never
> modified. This contract is the accepted historical record of K1. The
> executable cognition specification now lives in `qiven-context-draft`
> (ADR-0037).
