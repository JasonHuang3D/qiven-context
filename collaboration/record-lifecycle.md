...
`legacy/tools/record_lifecycle.py.md` (sealed museum text, ADR-0041) owns the shared predicate. Unknown categories or
...
`legacy/tools/test_record_lifecycle.py.md` (sealed museum text, ADR-0041) checked all schema-defined states across the real
...
history-to-current reuse. These checks ran before the ADR-0040/0041 seal;
they are not registered and do not run now. They proved lifecycle behavior,
not model ranking quality or general recall.
