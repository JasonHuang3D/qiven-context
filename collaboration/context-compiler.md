# Context Compiler — Deterministic Retrieval Baseline (sealed program, ADR-0040/0041)

> The compiler/retrieval implementation is museum material (ADR-0041:
> disarmed to non-executable legacy text; retrieval is performed by the
> reading agent until the Runtime program provides the capability —
> BOOTSTRAP step 13). This baseline and its amendments remain the
> semantic reference for any future Runtime-side implementation.
