...
Engineering sessions must reason from the broadest established engineering solution space available, not merely from the tools or abstractions already named in the current conversation (ADR-0044 standard posture, formerly split across participant roles).
