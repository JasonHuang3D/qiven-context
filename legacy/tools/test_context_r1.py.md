# [SEALED] tools/test_context_r1.py

> Museum piece (ADR-0040/ADR-0041, sealed 2026-09-21). Original
> location: `tools/test_context_r1.py`. Do not execute — this is historical text
...
class R1Tests(unittest.TestCase):
    ...
    def test_mandatory_view_closure_is_shared_with_candidate_bundle(self):
        ...
        expected = {"governance/authority.yaml", "views/bindings/chatgpt-jason.yaml",
