# [SEALED] tools/test_context_handoff.py

> Museum piece (ADR-0040/ADR-0041, sealed 2026-09-21). Original
> location: `tools/test_context_handoff.py`. Do not execute — this is historical text
...
class HandoffTests(unittest.TestCase):
    ...
    def test_operator_declares_one_shot_jasonpc_acceptance_gate(self):
        ...
        # cheap structural checks run before the expensive suite batch (fail-fast, 2026-09-21)
        self.assertEqual(config['gates']['k4-handoff-acceptance'],
                         ['bootstrap','diff-check','clean-tree','full-tests','k4-handoff-producer'])
