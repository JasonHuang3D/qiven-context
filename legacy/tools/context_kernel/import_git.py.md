# [SEALED] tools/context_kernel/import_git.py

> Museum piece (ADR-0040/ADR-0041, sealed 2026-09-21). Original
> location: `tools/context_kernel/import_git.py`. Do not execute — this is historical text
...
from .source_formats import StrictLoader, _front
