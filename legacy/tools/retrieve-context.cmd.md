# [SEALED] tools/retrieve-context.cmd

> Museum piece (ADR-0040/ADR-0041, sealed 2026-09-21). Original
> location: `tools/retrieve-context.cmd`. Do not execute — this is historical text
...
.venv\Scripts\python.exe tools\retrieve_context.py %*
exit /b %errorlevel%
