# Devkit (Phase-1-era project snapshot, museum)

> Museum (2026-09-26 PR4 doc-repair): the former live project entry,
> preserved verbatim. Its "current accepted state" pin (`022aaac`,
> template 0.1.2) and the "Operator Phase 1 paused" narrative are
> 2026-09-14-era history: the Operator landed long ago (gate/exec v2
> bounded custody/ci watch; ADR-0048/0051), templates rolled past 0.1.9,
> and qiven-workspace exists (ADR-0052). Current live entry:
