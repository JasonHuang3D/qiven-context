# Foundation (Phase I project snapshot, museum)

> Museum (2026-09-26 PR4 doc-repair): the former live project entry,
> preserved verbatim. Its "current verified state" pin (`6c09151e`,
> 2026-09-13) was a Phase-I-era checkpoint presented as current, and its
> ADR-0007 citation is superseded by ADR-0024 — the exact cold-boot
> contamination path the PR4 audit flagged. Current live entry:
> `projects/foundation/README.md`.
